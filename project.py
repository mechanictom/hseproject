...
st.write('Выбранные отрасли: добыча нефти, газа и угля - энергетический сектор добывающей промышленности,
	индустрия гостиничных услуг и общепита - отражает общий уровень потребления в обществе,\
	образование - как сфера, находившаяся в глубочайшем упадке после 1990-х, и несколько улучшившая\
	свои позиции к настоящему времени. Однако из графиков видно, какая индустрия в самом деле процветает.')
